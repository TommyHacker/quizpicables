...
} from "../../redux-toolkit/store/modal-slice";
...
const LandingPage = () => {
  ...
  const closeJoinModal = useSelector(
    (state) => !state.joinModal.modalIsVisible
  );
  const closeSettingsModal = useSelector(
    (state) => !state.settingsModal.settingsModalIsVisible
  );
