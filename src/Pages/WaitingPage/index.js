  ...
  return (
    <>
     <div className="background-container" style={{ backgroundImage: `url(${background})`, backgroundRepeat:"no-repeat",backgroundSize:"cover", height:'100vh',width:'100vw', color: 'white', padding: '25px'  }}>
      <Typography style={{fontSize: '4.2rem', textAlign: 'center', textShadow: '0px 0px 7px #665A9F,0px 0px 3px #665A9F'}}>Room number: {roomNumber}</Typography>
      <Typography style={{fontSize: '2rem', textShadow: '0px 0px 7px #665A9F,0px 0px 3px #665A9F'}}>Player Amount: {players.length}</Typography>
      ...
      <Typography style={{textAlign: 'center', fontSize: '5em', fontWeight: 'bold', letterSpacing: '3px', color: 'white', textShadow: '0px 0px 7px #665A9F,0px 0px 3px #665A9F' }}>- Loading Session -</Typography>
